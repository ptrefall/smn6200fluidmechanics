...
/////////////////////////////////////////////////////////////////////////////
// CL_EarClipTriangulator Construction:

CL_EarClipTriangulator::CL_EarClipTriangulator()
: impl(new CL_EarClipTriangulator_Impl)
{
}
...
/////////////////////////////////////////////////////////////////////////////
// CL_EarClipTriangulator Attributes:
...
/////////////////////////////////////////////////////////////////////////////
// CL_EarClipTriangulator Operations:

void CL_EarClipTriangulator::add_vertex(float x, float y)
{
	impl->add_vertex(x,y);
}
...
/////////////////////////////////////////////////////////////////////////////
// CL_EarClipTriangulator Implementation:
