...
{
	CL_Mat4<Type> rotation_matrix_x = CL_Mat4<Type>::rotate(angle_x, (Type)1.0f, (Type)0.0f, (Type)0.0f, false);
	CL_Mat4<Type> rotation_matrix_y = CL_Mat4<Type>::rotate(angle_y, (Type)0.0f, (Type)1.0f, (Type)0.0f, false);
	CL_Mat4<Type> rotation_matrix_z = CL_Mat4<Type>::rotate(angle_z, (Type)0.0f, (Type)0.0f, (Type)1.0f, false);
