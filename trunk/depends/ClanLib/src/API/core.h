...
//CODE ALTERED BY Paal Trefall (Just commented out some pragma lib commands at the end...
...
#define CL_CURRENT_VERSION	CL_VERSION(2,2,3)
#define CL_VERSION_STRING "2.2.3"
