...
///    connection between signals and slot_list by keeping all connections made
...
public:
	...
	{
		slot_list.push_back(sig.connect(func));
	}
	...
	{
		slot_list.push_back(sig.connect(self, func));
	}
	...
	{
		slot_list.push_back(sig.connect(func, user_data));
	}
	...
	{
		slot_list.push_back(sig.connect(self, func, user_data));
	}
	...
	{
		slot_list.push_back(sig.connect_functor(functor));
	}

private:
	std::vector<CL_Slot> slot_list;
/// \}
};
